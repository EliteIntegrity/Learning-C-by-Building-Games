...
// ============================================================
//
//  BSP generator, with added population: each generation also
//  spawns enemies and items at random floor tiles. Number of
//  enemies scales with `depth`.
// ============================================================
...
public:
    ...
    // Returns the suggested player start. Populates `enemies`
    // and `items` with freshly-built monsters and pickups.
