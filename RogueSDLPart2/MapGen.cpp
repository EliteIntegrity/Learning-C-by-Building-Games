...
namespace
{
    // Pick a random floor tile that isn't `avoid`.
    Point findFloor(Map& map, Point avoid)
    {
        ...
        return avoid;   // fallback; caller can detect collision
    }
}
                            ...
                            Point playerStart, int depth)
{
    ...
    for (int i = 0; i < totalEnemies; ++i)
    {
        ...
        // Higher depth -> more dangerous mix.
        int roll = rand() % 100;
    ...
    // A handful of potions and gold piles.
